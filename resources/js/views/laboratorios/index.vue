<template>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline mb-4">
                <h6 class="card-title mb-0">GESTIÓN DE LABORATORIOS</h6>
                  <div class="dropdown">
	...
	<laboratorio-modal v-if="showDialog" :form="form" @closeModal="closeModal" @saveAppt="saveAppt"/>
</template>
<script>
	import { deletable } from "../../mixins/deletable"
	import LaboratorioModal from "../laboratorios/form.vue"
	export default {
		mixins: [deletable],
		components: {
			LaboratorioModal
		...
		methods: {
			...
			getData(){
				...
				.then(res => {
					this.records = res.data.laboratorios
				})
			},
			clickCreate(){
