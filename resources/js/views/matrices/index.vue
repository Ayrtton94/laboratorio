<template>
          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-baseline mb-4">
                <h6 class="card-title mb-0">GESTIÓN DE MATRIZ</h6>
                  <div class="dropdown">
              ...
              <div class="table-responsive">
                  ...
                  <thead>
                    <tr>
                      <th class="pt-0">#</th>
                      <th class="pt-0">Nombre Matriz</th>
	...
	<matriz-modal v-if="showDialog" :form="form" @closeModal="closeModal" @saveAppt="saveAppt"/>
</template>
<script>
	import MatrizModal from "../matrices/form.vue"
	export default {
		components: {
			MatrizModal
		},
		...
		methods: {
			...
			getData(){
				...
				.then(res => {
					this.records = res.data.matrices
				})
			},
			clickCreate(){
