...
class CreateCatalogsTable extends Migration
{
	...
	public function up()
    {
        ...
        DB::table('cat_unit_types')->insert([
            ...
            ['id' => 'LTR', 'active' => true, 'symbol' => null, 'description' => 'LITRO'],
            ['id' => 'MTR', 'active' => true, 'symbol' => null, 'description' => 'METRO'],
            ...
            ['id' => 'PF', 'active' => true, 'symbol' => null, 'description' => 'PALETAS'],
            ['id' => 'PK', 'active' => true, 'symbol' => null, 'description' => 'PAQUETE'],
            ['id' => 'PR', 'active' => true, 'symbol' => null, 'description' => 'PAR'],
            ['id' => 'FTK', 'active' => true, 'symbol' => null, 'description' => 'PIES CUADRADOS'],
            ['id' => 'FTQ', 'active' => true, 'symbol' => null, 'description' => 'PIES CÚBICOS'],
            ['id' => 'C62', 'active' => true, 'symbol' => null, 'description' => 'PIEZAS'],
            ['id' => 'PG', 'active' => true, 'symbol' => null, 'description' => 'PLACAS'],
            ['id' => 'ST', 'active' => true, 'symbol' => null, 'description' => 'PLIEGO'],
            ['id' => '4A', 'active' => true, 'symbol' => null, 'description' => 'BOBINAS'],
            ['id' => 'BJ', 'active' => true, 'symbol' => null, 'description' => 'BALDE'],
            ['id' => 'BLL', 'active' => true, 'symbol' => null, 'description' => 'BARRILES'],
            ['id' => 'BG', 'active' => true, 'symbol' => null, 'description' => 'BOLSA'],
            ['id' => 'BO', 'active' => true, 'symbol' => null, 'description' => 'BOTELLAS'],
            ['id' => 'DZN', 'active' => true, 'symbol' => null, 'description' => 'DOCENA'],
            ['id' => 'DZP', 'active' => true, 'symbol' => null, 'description' => 'DOCENA POR 10**6'],
            ['id' => 'CMK', 'active' => true, 'symbol' => null, 'description' => 'CENTIMETRO CUADRADO'],
            ['id' => 'CMQ', 'active' => true, 'symbol' => null, 'description' => 'CENTIMETRO CUBICO'],
            ['id' => 'CMT', 'active' => true, 'symbol' => null, 'description' => 'CENTIMETRO LINEAL'],
            ['id' => 'CEN', 'active' => true, 'symbol' => null, 'description' => 'CIENTO DE UNIDADES'],
            ['id' => 'CT', 'active' => true, 'symbol' => null, 'description' => 'CARTONES'],
            ['id' => 'CY', 'active' => true, 'symbol' => null, 'description' => 'CILINDRO'],
            ['id' => 'CJ', 'active' => true, 'symbol' => null, 'description' => 'CONOS'],
            ['id' => 'BL', 'active' => true, 'symbol' => null, 'description' => 'FARDO'],
